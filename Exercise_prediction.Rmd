...
is to predict the manner in which they did the exercise. Randomforest 
algorithm is used as the prediction model and perfoms very well with 
accuracy range of 0.9949058 to 0.9989806
...
very well with accuracy range of 0.9964 to 0.9969. So, we use as the
